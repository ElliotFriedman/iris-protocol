...
contract MultiAgentTest is Test {
    ...
    function test_multiAgentIsolation() public {
        ...
        vm.prank(agentB);
        this.helperRedeem(chainB2, action);
        ...
        vm.prank(agentC);
        this.helperRedeem(chainC2, action);
    }
    ...
    function test_agentSpecificCaps() public {
        ...
        this.helperRedeem(chainA, bigAction);

        // B can do 2 ETH (cap 5)
        vm.prank(agentB);
        this.helperRedeem(chainB, bigAction);
        assertEq(target.value(), 1);
    }
}
