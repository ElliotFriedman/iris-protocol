  ...
  return (
    <section id="reputation" className="py-32 px-6 bg-void">
      <div className="max-w-6xl mx-auto">
        <h2 className="font-mono text-2xl sm:text-4xl md:text-5xl font-bold text-bone text-center mb-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col sm:flex-row flex-wrap lg:flex-nowrap items-center justify-center gap-4">
            {[
              ...
              <div key={item.step} className="flex items-center gap-4">
                <div className="bg-onyx border border-iris-purple/30 rounded-xl p-5 text-center min-w-[160px]">
                ...
                {i < 3 && (
                  <span className="hidden lg:block text-electric-cyan font-mono text-xl">&rarr;</span>
                )}
              </div>
            ))}
          </div>
