# Iris Protocol — Brand Don'ts

Check all assets against this list before shipping.
...
- **Don't add a token.** "Iris is infrastructure. Infrastructure doesn't need a token."
- **Don't use hype language.** No "revolutionary," "game-changing," "next-generation," "unlock the future."
